      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-600">総合進捗</p>
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-600">完了タスク</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-600">現在の連続記録</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-600">最高連続記録</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900">
                {stats.bestStreak}日
              </p>
            </div>
        ...
        <div className="space-y-2">
          {stats.dailyStats.slice(-7).map((day) => (
            <div key={day.date} className="flex items-center gap-2 sm:gap-3">
              <div className="w-16 sm:w-20 text-xs sm:text-sm text-gray-600">
              ...
              <div className="w-10 sm:w-12 text-xs text-gray-500 text-right">
                {Math.round(day.rate)}%
              </div>
            </div>
          ))}
